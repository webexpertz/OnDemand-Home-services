...
/**
 * Generated class for the EditmemebershipPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-editmemebership',
  templateUrl: 'editmemebership.html',
})
export class EditmemebershipPage {
 private selectedPackage = 'monthly';
  ...
  constructor(private strip: Stripe,  public app: App, public navCtrl: NavController, public navParams: NavParams, private authService: AuthServiceProvider, private loadingController: LoadingController, private toastCtrl: ToastController) {
